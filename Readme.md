[![Build and test the esy package](https://github.com/ManasJayanth/esy-gmp/actions/workflows/workflow.yml/badge.svg)](https://github.com/ManasJayanth/esy-gmp/actions/workflows/workflow.yml)

# esy-gmp

`esy-gmp` is sample package, [`hello`](https://github.com/esy/test-hello-c), packaged for [`esy`](https://esy.sh/).
...
`esy-gmp` can be used from both NPM and directly from Github.

### From NPM 

`esy-gmp` is deployed on NPM can be found
[here](https://www.npmjs.com/package/TODO).

You can simply run `esy add esy-gmp` to install it, or specify it in
...
```diff
  "dependencies": {
+   "esy-gmp": "esy-packages/esy-gmp#<commit hash>"
  }
```
